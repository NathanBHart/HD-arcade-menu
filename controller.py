...
class Controller:
    ...
    def __init__(self, controller_id):
        ...
        if pygame.joystick.get_count() >= self.id + 1:
    ...
    def update(self):
        ...
        for i in range(5):
            ...
            if self.Object.get_button(i):
                self.current_buttons.append(i)
    ...
    def to_button_id(self, input):
        ...
        if input in range(0, 5):
            ...
            if input == "a":
                ...
                print("Input controller value must be between 0-3, or "
                      "\"a\", \"b\", \"x\", \"y\", \"player\", or \"menu\".")
                return None

        else:
            print("Invalid input. Input controller value must be between 0-3, or "
                  "\"a\", \"b\", \"x\", \"y\", \"player\", or \"menu\".")
            return None
    ...
    def is_button_pressed(self, button):
        ...
        if id is not None:
            return self.Object.get_button(id)
